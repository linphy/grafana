      ...
      _export('PieChartCtrl', PieChartCtrl = function (_MetricsPanelCtrl) {
        ...
        _createClass(PieChartCtrl, [{
          ...
          value: function getDecimalsForValue(value) {
            if (this.panel.decimals > 0) {
              return { decimals: parseInt(this.panel.decimals + ""), scaledDecimals: null };
            }
          ...
          value: function formatValue(value) {
            ...
            if (formatFunc) {
              var returnValue = formatFunc(value, decimalInfo.decimals, decimalInfo.scaledDecimals);
              if ("NaN.nfinity" == returnValue) {
                return "0";
              }
              return returnValue;
            }
