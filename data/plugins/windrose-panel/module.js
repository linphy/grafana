System.register(["app/plugins/sdk", "lodash", "jquery", "vendor/plotly/plotly.min.js"], function (exports_1, context_1) {
    "use strict";
        ...
        execute: function () {
            PlotlyPanelCtrl = (function (_super) {
                ...
                PlotlyPanelCtrl.prototype.onInitEditMode = function () {
                    this.addEditorTab('Display', 'public/plugins/windrose-panel/templates/tab_display.html', 2);
                    this.refresh();
                    this.segs = {
                ...
                PlotlyPanelCtrl.prototype.onRender = function () {
                    ...
                    var gp = jquery_1.default(this.graph).parent();
                    var size = Math.min(gp.width(), gp.height());
                    if (!this.initalized) {
                        var options = {
                            showLink: false,
                            displaylogo: false,
