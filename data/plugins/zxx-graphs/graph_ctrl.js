		...
		execute: function () {
			...
			_export('EchartsCtrl', EchartsCtrl = function (_MetricsPanelCtrl) {
				...
				function EchartsCtrl($scope, $injector, $rootScope) {
					...
					var preciseOption = [{ name: '0', value: 0 }, { name: '1', value: 1 }, { name: '2', value: 2 }, { name: '3', value: 3 }, { name: '4', value: 4 }, { name: '5', value: 5 }, { name: '6', value: 6 }];
					...
					_this.panel.colorOption = colorOption;
				...
				_createClass(EchartsCtrl, [{
					...
					value: function fixed() {
						if (this.panel.mode == 'json') {
							...
							} else if (this.dataList[0].datapoints[0][0] == -9999) {
								//过滤掉-9999
								this.panel.data = "-";
							} else {
