		...
		execute: function () {
			...
			_export('EchartsCtrl', EchartsCtrl = function (_MetricsPanelCtrl) {
				...
				function EchartsCtrl($scope, $injector, $rootScope) {
					...
					var modeOption = [{ name: 'KPI主信息', value: "kpi" }, { name: 'KPI仪表盘', value: "kpiGauge" }, { name: 'KPI趋势图', value: "kpiTrend" }, { name: 'KPI描述', value: "kpiDesc" }, { name: 'KPI链接', value: "kpiWebUrl" }, { name: '告警信息', value: "alarmInfo" }, { name: '告警分布饼图', value: "alarmPie" }, { name: '关联量信息1', value: "relativeInfo1" }, { name: '关联量趋势1', value: "relativeTrend1" }, { name: '关联量信息2', value: "relativeInfo2" }, { name: '关联量趋势2', value: "relativeTrend2" }];
